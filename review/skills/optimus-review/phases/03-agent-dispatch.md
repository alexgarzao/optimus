...
Loaded by `SKILL.md` after Phase 2 completes. Dispatch all review droids in parallel with the agent prompt template, severity classification, and special instructions per agent.
