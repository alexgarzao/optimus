...
- `Validando Spec` (stage-1-spec running)
- `Em Andamento` (stage-2-impl running)
- `Validando Impl` (stage-3-impl-review running)
- `Revisando PR` (stage-4-pr-review running)
