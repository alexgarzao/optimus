...
| `cycle-batch` | Pipeline orchestrator — chains stages 1-5 with user checkpoints | `/optimus-cycle-batch` |
| `cycle-conflict-resolve` | Resolves merge conflicts in tasks.md from parallel execution | `/optimus-cycle-conflict-resolve` |
...
|-------|-------|-------------|---------|
| `cycle-spec-stage-1` | 1 | Validates specs + creates worktree | `/optimus-cycle-spec-stage-1` |
