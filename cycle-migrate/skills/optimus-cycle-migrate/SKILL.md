...
trigger: >
  ...
  - When cycle-spec-stage-1 can't find a valid tasks.md
skip_when: >
...
2. Run `/optimus-cycle-report` to see the dashboard
3. Run `/optimus-cycle-spec-stage-1` on the first pending task
```
