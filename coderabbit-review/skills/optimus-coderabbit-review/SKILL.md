...
For EACH finding, present with `"Finding X/N"` in the header, including the origin tag:
- Regular: `## Finding X/N — [SEVERITY] | CodeRabbit | Category`
- Duplicate: `## Finding X/N — [SEVERITY] | CodeRabbit — DUPLICATE | Category`
- Outside diff: `## Finding X/N — [SEVERITY] | CodeRabbit — OUTSIDE PR DIFF | Category`
